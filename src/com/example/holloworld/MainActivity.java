...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		recordButton.setOnClickListener(new recordClick());
	...
	public class recordClick implements OnClickListener {
		@Override
		public void onClick(View arg0) {
			...
			if(recordButton.getText().equals(getString(R.string.record_start))){
	...
	public class playClick implements OnClickListener {
		@Override
		public void onClick(View arg0) {
			// TODO Auto-generated method stub
			if(playButton.getText().equals(getString(R.string.play_start))){
				...
				playButton.setText(R.string.play_start);
				mPlayer.stop();
			}
		}
	}
